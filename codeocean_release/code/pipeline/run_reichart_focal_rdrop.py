# run_reichart_focal_rdrop.py
# 职责: reichart Focal Loss γ=2 + R-Drop α=0.2 组合
# 断点: output/supcon_ablation/reichart_focal_rdrop.csv
...
def main():
    ...
    print(f'\n{"="*60}')
    print(f'  reichart Focal(γ=2) + R-Drop(α=0.2)')
    ...
    row = {
        ...
        'use_rdrop': True, 'rdrop_alpha': 0.2,
