...
_DATASET_CONFIGS = {
    'habermann': {'gene_emb_dim': 32,  'dropout': 0.40, 'pretrain_epochs': 30, 'n_seeds': 1, 'specificity_alpha': 0.0, 't_alpha': 0.3, 'lfc_alpha': 0.0, 'use_esm2': True, 'use_kge': True, 'esm2_alpha': 0.0, 'kge_alpha': 0.0, 'esm2_selection': False, 'enable_pretraining': False, 'condition_key': 'Status'},
    'velmeshev': {'gene_emb_dim': 96,  'dropout': 0.25, 'pretrain_epochs': 30, 'n_seeds': 1, 'specificity_alpha': 0.0, 't_alpha': 0.0, 'lfc_alpha': 0.0, 'quality_lr_cutoff': 150, 'score_formula': 'mean', 'use_esm2': True, 'use_kge': True, 'esm2_alpha': 0.0, 'kge_alpha': 0.0, 'esm2_selection': False, 'enable_pretraining': False, 'condition_key': None},
    'kuppe':     {'gene_emb_dim': 128, 'dropout': 0.20, 'pretrain_epochs': 30, 'n_seeds': 1, 'specificity_alpha': 0.0, 't_alpha': 0.0, 'lfc_alpha': 0.0, 'use_esm2': True, 'use_kge': True, 'esm2_alpha': 0.0, 'kge_alpha': 0.0, 'esm2_selection': False, 'enable_pretraining': False, 'condition_key': None},
    'carraro':   {'gene_emb_dim': 48,  'dropout': 0.40, 'pretrain_epochs': 30, 'n_seeds': 1, 'specificity_alpha': 0.0, 't_alpha': 0.0, 'lfc_alpha': 0.3, 'use_esm2': True, 'use_kge': True, 'esm2_alpha': 0.0, 'kge_alpha': 0.0, 'esm2_selection': False, 'enable_pretraining': False, 'condition_key': None},
    'reichart':  {'gene_emb_dim': 64,  'dropout': 0.30, 'pretrain_epochs': 30, 'n_seeds': 1, 'specificity_alpha': 0.0, 't_alpha': 0.0, 'lfc_alpha': 0.0, 'use_esm2': True, 'use_kge': True, 'esm2_alpha': 0.0, 'kge_alpha': 0.0, 'esm2_selection': False, 'enable_pretraining': False, 'condition_key': None},
    'default':   {'gene_emb_dim': 64,  'dropout': 0.30, 'pretrain_epochs': 30, 'n_seeds': 1, 'specificity_alpha': 0.0, 't_alpha': 0.0, 'lfc_alpha': 0.0, 'use_esm2': True, 'use_kge': True, 'esm2_alpha': 0.0, 'kge_alpha': 0.0, 'esm2_selection': False, 'enable_pretraining': False, 'condition_key': None},
}
...
def _build_batch_entries(valid_lr_pairs, gene_names, ct_expr_dict,
                         gene_to_idx, ct_to_idx, valid_cts):
    """构建批量推断数据"""
    batch_data = []
