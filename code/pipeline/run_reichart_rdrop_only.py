# run_reichart_rdrop_only.py
# 职责: reichart R-Drop α=0.3 单独（不加 Class Weight）— 隔离 R-Drop 效果
# 断点: output/supcon_ablation/reichart_rdrop_only.csv
...
def main():
    ...
    print(f'\n{"="*60}')
    print(f'  reichart R-Drop α=0.3 only (no class weight)')
