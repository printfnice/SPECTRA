# run_reichart_cw_only.py
# 职责: reichart Class-Weighted CE only（隔离 class weight 效果）
# 断点: output/supcon_ablation/reichart_cw_only.csv
...
def main():
    ...
    print(f'\n{"="*60}')
    print(f'  reichart Class-Weighted CE only')
