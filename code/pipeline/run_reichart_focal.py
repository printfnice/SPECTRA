# run_reichart_focal.py
# 职责: reichart w03_mixoff + Focal Loss γ=2（聚焦 fold1/4 难样本）
# 断点: output/supcon_ablation/reichart_supcon_w03_focal.csv
...
def main():
    ...
    print(f'\n{"="*60}')
    print(f'  reichart w03_mixoff + Focal Loss γ=2')
    print(f'  对比: CE={BASELINE_W03}  目标: >{CELLCHAT}')
    print(f'  设备: {device}')
    print(f'{"="*60}')
    ...
    print(f'  vs w03_CE: {mean_auroc - BASELINE_W03:+.4f}')
