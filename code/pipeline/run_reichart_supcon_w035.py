# run_reichart_supcon_w035.py
# 依赖: e2e_pipeline.py, e2e_utils.py
# 职责: reichart SupCon w=0.35 消融（w=0.3最优0.9641 vs w=0.4失败0.8883）
#
# 背景: w=0.3→0.9641，w=0.4→0.8883（rs3/rs4方差爆炸）
#       w=0.35 是中间点，期望在不触发不稳定的前提下取得更高均值
#
# 断点: output/supcon_ablation/reichart_supcon_w035_mixoff.csv
...
def main():
    ...
    print(f'\n{"="*60}')
    print(f'  reichart SupCon w=0.35 实验')
    print(f'  对比: w=0.3={BASELINE_W03}, w=0.4=0.8883(失败)')
